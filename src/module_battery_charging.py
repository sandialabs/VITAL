...
class BatteryCharging:
    ...
    def chargeBattery_continuous(self, Pelec, t, visualise=True):
        cumulative_energy_J = integrate.cumulative_trapezoid(y=Pelec, x=t, initial=0)
    ...
    def chargeBattery_perDay(self, Pelec, t, visualise=True):
        ...
        # Truncate t and Pelec to the nearest multiple of lenPerDay
        num_days = len(t) // lenPerDay
        t = t[:num_days * lenPerDay]
        Pelec = Pelec[:num_days * lenPerDay]
